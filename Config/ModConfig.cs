...
namespace SmithYourself.Config
{
    internal class ModConfig
    {
        public string MinigameDifficulty { get; set; } = "Normal";
        ...
        public float MinigameCooldown { get; set; } = 0.75f;
        public float HardMinigameSpeedIncrement { get; set; } = 0.15f;
